  ...
  return (
    <div className="flex items-center justify-between h-full p-8 gap-8">
      <div className="flex flex-col">
        <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&weight=600&size=54&duration=3000&pause=1000&color=06b6d4&vCenter=true&random=false&width=600&height=70&lines=%2F%2F+muhammadoka.dev;%2F%2E%2A%5C%2E%28go%7Cpy%7Crs%29%24%2F" alt="Typing SVG" /></a>
        <p className="md:text-xl">telling computers what to do since 2012.</p>
      </div>
